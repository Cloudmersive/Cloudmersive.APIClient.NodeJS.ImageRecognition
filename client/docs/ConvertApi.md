# CloudmersiveImageApiClient.ConvertApi
...
[**convertToJpg**](ConvertApi.md#convertToJpg) | **POST** /image/convert/to/jpg/{quality} | Convert input image to JPG, JPEG format at specific quality
[**convertToJpgDefaultQuality**](ConvertApi.md#convertToJpgDefaultQuality) | **POST** /image/convert/to/jpg | Convert input image to JPG, JPEG format
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **quality** | **Number**| Set the JPEG quality level; lowest quality is 1 (highest compression), highest quality (lowest compression) is 100; recommended value is 75 | 
 **imageFile** | **File**| Image file to perform the operation on.  Common file formats such as PNG, JPEG are supported. | 
...
<a name="convertToJpgDefaultQuality"></a>
# **convertToJpgDefaultQuality**
> Object convertToJpgDefaultQuality(imageFile)
...
apiInstance.convertToJpgDefaultQuality(imageFile, callback);
```
