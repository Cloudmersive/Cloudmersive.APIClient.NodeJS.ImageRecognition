# CloudmersiveImageApiClient.PersonWithAge
...
**age** | **Number** | The specific estimated age of the person | [optional] 
**genderClassification** | **String** | Gender estimation classification as Female or Male | [optional] 
**genderFemaleConfidence** | **Number** | Confidence level of classification as female; possible values are between 0.0 and 1.0 | [optional] 
**genderMaleConfidence** | **Number** | Confidence level of classification as male; possible values are between 0.0 and 1.0 | [optional] 
